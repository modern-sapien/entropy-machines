 ...
 *
 *   npm run changelog:new -- "fix(agent): read_snapshot carries the locator" i-read-snapshot-drops-locator
 *
...
if (!titleArg) {
  console.error('usage: npm run changelog:new -- "type(scope): subject" [issue-id]');
  process.exit(2);
}
